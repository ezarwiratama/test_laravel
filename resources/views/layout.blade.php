...
initial-scale=1">
    <title>Modul 2 Kelompok 57</title>
    <!-- Fonts -->
    <link
        href="https://fonts.bunny.net/css2?family=Nunito:wght@
400;600;700&display=swap" rel="stylesheet">
    <!-- Styles -->
    <link
        href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dis
...
route('admin.index') }}">Modul 2 SBD - Kelompok 57</a>
        </div>
    </nav>
